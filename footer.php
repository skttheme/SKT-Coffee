...
<div id="footer-wrapper">
        ...
        <div class="copyright-wrapper">
        	<div class="container">
                <div class="copyright-txt"><?php esc_html_e('&copy; 2025','skt-coffee');?> <?php bloginfo('name'); ?>. <?php esc_attr_e('All Rights Reserved', 'skt-coffee');?></div>
                <div class="design-by"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-coffee');?> <a href="<?php echo esc_url('https://www.sktthemes.org/product-category/restaurant/');?>" target="_blank">
        <?php esc_html_e('SKT Restaurant Themes','skt-coffee'); ?>
        </a></div>
            </div>
            <div class="clear"></div>
        </div>
